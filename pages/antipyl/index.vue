...
const faqSchema = computed(() => ({
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: `Для кого подходит сетка Антипыль в ${tenant.config.city || 'Чебоксарах'}?`, acceptedAnswer: { '@type': 'Answer', text: `Для аллергиков, жителей домов у дорог в ${tenant.config.city || 'Чебоксарах'} и тех, кто хочет меньше пыли в квартире. Полотно Poll-Tex задерживает до 90% пыльцы и уличной пыли благодаря электростатическому эффекту.` } },
    { '@type': 'Question', name: `Как часто нужно мыть сетку Антипыль от ${tenant.config.dealer_name || 'Сетки 21'}?`, acceptedAnswer: { '@type': 'Answer', text: 'Рекомендуем промывать под душем 1–2 раза в сезон или по мере загрязнения. Нейлоновое полотно легко очищается, подоконники остаются чище в 3 раза дольше.' } },
        ...
        <div class="flex flex-col lg:flex-row gap-12 items-stretch mb-8 min-h-[440px]">
          <div class="lg:w-1/2 flex flex-col justify-start pt-4 min-h-[440px]">
            <h1 class="text-4xl md:text-5xl font-black mb-6 leading-tight uppercase tracking-tight">
              Сетка <span class="text-brand-blue" :style="{ color: tenant.config.branding?.primary_color || '#2A6AB2' }">Антипыль</span> — задерживает 97% пыльцы
            </h1>
          ...
          <div class="lg:w-1/2 relative flex items-start pt-4 justify-end">
            <div class="relative w-full max-w-[640px]">
              <HeroImage
                ...
                :alt="`Как замерить москитную сетку Антипыль Poll-Tex на пластиковом окне в ${tenant.config.city || 'Чебоксарах и Новочебоксарске'}`"
                :title="`Сетка Антипыль в ${tenant.config.city || 'Чебоксарах'}`"
      ...
      <div class="container mx-auto px-4">
          ...
          <div class="bg-brand-dark rounded-[4rem] p-10 md:p-20 text-white relative overflow-hidden shadow-2xl">
            <div class="relative z-10">
              <h2 class="text-3xl font-black mb-12 uppercase tracking-widest text-center text-white">Почему наши сетки Антипыль?</h2>
              <div class="grid md:grid-cols-3 gap-12">
                ...
                <div class="text-center md:text-left group">
                  ...
                  <h3 class="font-black text-xl mb-4 uppercase tracking-tighter text-white">Чистый воздух</h3>
                  <p class="text-gray-400 text-sm leading-relaxed font-medium group-hover:text-white/80 transition-colors">Идеальное решение для аллергиков и жителей домов рядом с оживленными дорогами.</p>
                </div>
                <div class="text-center md:text-left group">
                  ...
                  <p class="text-gray-400 text-sm leading-relaxed font-medium group-hover:text-white/80 transition-colors">Полотно легко промывается обычной водой, быстро восстанавливая пропускную способность.</p>
                </div>
              </div>
            </div>
