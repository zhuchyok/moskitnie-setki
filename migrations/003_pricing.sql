...
VALUES ('global_pricing', '{
  ...
  "components": [
    ...
    {"id": "handle_plastic", "name": "Ручка пластик (шт)", "price": 2.2},
    {"id": "handle_metal", "name": "Ручка metal (пара)", "price": 50.0},
    {"id": "mount_plastic", "name": "Крепления пластик (комплект)", "price": 40.0},
    {"id": "mount_metal", "name": "Крепления металл (комплект)", "price": 40.0},
    {"id": "mount_vsn", "name": "Крепление VSN (шт)", "price": 30.0},
    {"id": "mount_impost", "name": "Крепление импоста (шт)", "price": 1.8},
    {"id": "screw", "name": "Саморез (шт)", "price": 1.0},
    {"id": "rivet", "name": "Клепка (шт)", "price": 5.0},
    {"id": "washer", "name": "Шайба (шт)", "price": 2.0},
