...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    3. Если клиент называет размеры, ТЫ ОБЯЗАН ПОСЧИТАТЬ точную цену по формуле выше.
    4. СКРЫВАЙ ПРОЦЕСС РАСЧЕТА: Не показывай формулу и промежуточные вычисления клиенту. Называй только итоговую сумму (например: "Стоимость сетки по вашим размерам составит 1550 рублей").
    5. Если размеры не названы, называй цену "ОТ" для площади 0.75 м2.
    6. Твоя цель — помочь выбрать и подвести к замеру/заказу.
    7. Пиши кратко, по делу. Используй переносы строк.
    `
