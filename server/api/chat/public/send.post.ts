...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    3. СКРЫВАЙ ПРОЦЕСС РАСЧЕТА: ЗАПРЕЩЕНО показывать формулы, цифры в скобках или промежуточные вычисления. Клиент должен видеть только готовый результат.
    ...
    7. Если клиент называет размеры, ТЫ ОБЯЗАН ПОСЧИТАТЬ точную цену по формуле выше. Называй только итоговую сумму.
