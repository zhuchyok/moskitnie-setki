          ...
          <div class="lg:w-1/2">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                <p class="font-black text-brand-blue text-2xl mb-1">Poll-Tex</p>
                <p class="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Нейлоновое полотно</p>
              </div>
              <div class="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                <p class="font-black text-brand-blue text-2xl mb-1">90%</p>
        ...
        <div class="max-w-5xl mx-auto">
          <div class="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div class="relative group">
              <img src="/upload/iblock/963/963b80b25938266f19cda63ac6f838b4.png" alt="Ручки для сетки Антипыль" class="rounded-3xl shadow-lg order-2 md:order-1 group-hover:scale-105 transition-transform duration-500" />
            </div>
