...
/** Конфигурация ценообразования - входные цены из админки.
 * Ручки ПВХ 2,2₽×2; ручки металл 8₽×2 (в калькуляторе округление клиент 50, дилер 10).
 * Крепления рамочные 8₽×4; вставные 30₽×4; импост 1,8₽×2. Уголки 4 шт. Саморезы рамочные 12 шт; вставные 2 шт; клепки вставные 2 шт.
 */
export const PRICING_CONFIG = {
  fixed: {
    handles: 4.4, /* 2,2₽ × 2 шт (ручки ПВХ) */
    handlesMetalCost: 16, /* 8₽ × 2 шт — себестоимость металл. ручек; в калькуляторе округление 50 клиент / 10 дилер */
    stretch: 24,
    workBase: 60,
    workPercent: 0.1,
  },
  /** Рамочная: уголки 4 шт, ручки 2×2,2, крепления 8₽×4, импост 1,8₽×2, саморезы 12 шт */
  fixedRamochnaya: {
    cornersByColor: { 1: 3.75, 2: 6, 3: 7, 4: 7 },
    mountPerPiece: 8,
    mountCount: 4,
    impostMountCount: 2,
  ...
  /** Вставная VSN: уголки 4 шт, ручки 2×2,2, крепления 30₽×4, импост 1,8₽×2, саморезы 2 шт, клепки 2 шт */
  fixedVstavnaya: {
    cornersByColor: { 1: 14.8, 2: 4.85, 3: 7.15, 4: 7.15 },
    mountPerPiece: 30,
    mountCount: 4,
    impostMountCount: 2,
    impostMountPrice: 1.8,
  ...
  /** Доп. услуги. Ручка металл: себестоимость 8×2=16, в калькуляторе округление клиент 50 / дилер 10. */
  extras: {
    installation: 400,
    handleMetal: 50, /* цена для клиента по умолчанию (округление до 50) */
    handleMetalDealerRound: 10,
  },
