...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/api/v1/admin/orders/:id", get(handlers::admin::get_order_detail).delete(handlers::admin::delete_order))
        .route("/api/v1/admin/callbacks", get(handlers::admin::list_all_callbacks))
        .route("/api/v1/admin/callbacks/:id", axum::routing::delete(handlers::admin::delete_callback))
