...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    4. Если размеры не названы, называй цену "ОТ" для площади 0.75 м2.
    5. Твоя цель — помочь выбрать и подвести к замеру/заказу.
    6. Пиши кратко, по делу. Используй переносы строк.
    `
