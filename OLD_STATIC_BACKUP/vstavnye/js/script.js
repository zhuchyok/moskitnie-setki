function calc() {
  ...
  price = PRICES_VSTAVNYE[offset + index];

  $(".price span, .price-dynamic").text(price);
}

function add_order() {
  //$( ".list_order table" ).append( "<tr><td> 1. </td><td> Противомоскитная сетка Дверная - </td><td> - белая рамка - </td><td> - 500x1200 мм - </td><td> - 2 ШТ - </td><td> - 1160 Р </td></tr>" );
...
function setMinimalSliderValues() {
  ...
  var minPrice = PRICES_VSTAVNYE[0]; // белая рамка, индекс 0
  var minPriceIndex = 0;
