// core/repository/mod.rs - Трейты для работы с данными
...
pub trait DepartmentRepository: Send + Sync {
    ...
    async fn create(&self, department: DealerDepartment) -> CoreResult<DealerDepartment>;
    async fn update(&self, department: DealerDepartment) -> CoreResult<DealerDepartment>;
    async fn delete(&self, id: Uuid) -> CoreResult<()>;
...
/// Трейт для работы с логами аудита
#[async_trait]
