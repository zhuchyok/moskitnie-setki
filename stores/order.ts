...
export const useOrderStore = defineStore('order', {
  state: () => ({
    prices: {
      // Стандарт: белая (0-15), коричневая (16-31), антрацит (32-47), RAL (48-63)
      standart: [
      ...
      // Антимошка: белая (0-15), коричневая (16-31), антрацит (32-47), RAL (48-63)
      antimoshka: [
      ...
      // Антикошка: белая (0-15), коричневая (16-31), антрацит (32-47), RAL (48-63)
      antikoshka: [
      ...
      // Антипыль: белая (0-15), коричневая (16-31), антрацит (32-47), RAL (48-63)
      antipyl: [
      ...
      // Вставные VSN: белая (0-15), коричневая (16-31), антрацит (32-47), RAL (48-63)
      vstavnye: [
  ...
  getters: {
    currentPrice: (state) => {
      ...
      const selectedPrices = state.prices[state.config.type as keyof typeof state.prices] || state.prices.standart
      return selectedPrices[offset + index] || 0
    },
    totalPrice: (state) => {
