        ...
        <div class="bg-gray-50 rounded-[3rem] p-8 md:p-16 shadow-sm border border-gray-100">
          ...
          <div class="prose prose-blue max-w-none text-gray-600 space-y-10 font-medium text-sm md:text-base">
            <div class="section">
              ...
              <p>
                1.3. Настоящая Политика применяется ко всей информации, которую Оператор может получить о пользователе во время использования сайта <a :href="url" class="text-brand-blue underline notranslate">{{ tenant.config.domain || 'сеткимоскитки.рф' }}</a> и его поддоменов, а также при взаимодействии по телефону и электронной почте.
              </p>
            </div>
            ...
            <div class="section bg-white p-8 rounded-3xl border border-gray-100">
              ...
              <p class="mt-6 text-xs text-gray-400 italic">
                Действующая редакция Политики опубликована на сайте <span class="notranslate">{{ tenant.config.domain || 'сеткимоскитки.рф' }}</span>. Оператор вправе вносить изменения в настоящую Политику.
              </p>
            </div>
          </div>
